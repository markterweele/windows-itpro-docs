...
| ----------- | --------------------- | ------ |
| Data Encryption Standard (DES) <!--9720338--> | DES, the symmetric-key block encryption cipher, is considered insecure against modern cryptographic attacks, and replaced by more robust encryption algorithms. DES was disabled starting with Windows 7 and Windows Server 2008 R2. It's removed and is removed from Windows 11, version 24H2 and later, and [Windows Server 2025](/windows-server/get-started/removed-deprecated-features-windows-server-2025) and later.| February 2025 | 
